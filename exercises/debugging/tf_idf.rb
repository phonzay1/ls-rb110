...
puts tfidf("cat", document3, documents) # 0 - outputs correctly

puts tfidf("quantum", document1, documents) # ~ 5.5 - outputs correctly
puts tfidf("quantum", document2, documents) # 0 - outputs correctly
puts tfidf("quantum", document3, documents) # 0 - outputs correctly

puts tfidf("mastery", document1, documents) # 0 - outputs correctly
puts tfidf("mastery", document2, documents) # 0 - outputs correctly
puts tfidf("mastery", document3, documents) # ~ 4.4 - outputs correctly

puts tfidf("some", document1, documents) # 0 - outputs correctly
